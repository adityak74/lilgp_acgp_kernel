          ...
          for ( j = 0; j < tree_count; ++j )
          {
               ...
               if ( attempts <= 0 )
                    error ( E_FATAL_ERROR,
                        ...
                        "The last %d trees generated have been bad. Giving up. This is likely caused by heavy constraints making the tree space very sparse, unable to uniquely initialize your population. If so, you may reduce population size or increase the initialization depth ramp.",   
			attempts_generation );
