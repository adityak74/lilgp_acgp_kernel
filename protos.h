...
/*** regrow2Global mwh added operator to do regrowth with lvl 1 information ***/
int operator_regrow2Global_init ( char *options, breedphase *bp );
void operator_regrow2Global_free ( void * );
void operator_regrow2Global_start ( population *oldpop, void *data );
void operator_regrow2Global_end ( void *data );
void operator_regrow2Global ( population *oldpop, population *newpop, void *data );

/*** mutate2Global mwh added operator to do mutation with lvl 1 information ***/
int operator_mutate2Global_init ( char *options, breedphase *bp );
void operator_mutate2Global_free ( void * );
void operator_mutate2Global_start ( population *oldpop, void *data );
void operator_mutate2Global_end ( void *data );
void operator_mutate2Global ( population *oldpop, population *newpop, void *data );

/*** crossover2Global mwh added operator to do crossover with lvl 1 information ***/
int operator_crossover2Global_init ( char *options, breedphase *bp );
void operator_crossover2Global_free ( void * );
void operator_crossover2Global_start ( population *oldpop, void *data );
void operator_crossover2Global_end ( void *data );
void operator_crossover2Global ( population *oldpop, population *newpop, void *data );


/*** regrow2 mwh added operator to do regrowth with lvl 1 and local information ***/
int operator_regrow2_init ( char *options, breedphase *bp );
void operator_regrow2_free ( void * );
void operator_regrow2_start ( population *oldpop, void *data );
void operator_regrow2_end ( void *data );
void operator_regrow2 ( population *oldpop, population *newpop, void *data );

/*** mutate2 mwh added operator to do mutation with lvl 1 and local information ***/
int operator_mutate2_init ( char *options, breedphase *bp );
void operator_mutate2_free ( void * );
void operator_mutate2_start ( population *oldpop, void *data );
void operator_mutate2_end ( void *data );
void operator_mutate2 ( population *oldpop, population *newpop, void *data );

/*** crossover2 mwh added operator to do crossover with lvl 1 and localinformation ***/
int operator_crossover2_init ( char *options, breedphase *bp );
void operator_crossover2_free ( void * );
void operator_crossover2_start ( population *oldpop, void *data );
void operator_crossover2_end ( void *data );
void operator_crossover2 ( population *oldpop, population *newpop, void *data );

/*** crossover2Local mwh added operator to do crossover with local information ***/
int operator_crossover2Local_init ( char *options, breedphase *bp );
void operator_crossover2Local_free ( void * );
void operator_crossover2Local_start ( population *oldpop, void *data );
void operator_crossover2Local_end ( void *data );
void operator_crossover2Local ( population *oldpop, population *newpop, void *data );


/*** regrow2Local mwh added operator to do regrow with local information ***/
int operator_regrow2Local_init ( char *options, breedphase *bp );
void operator_regrow2Local_free ( void * );
void operator_regrow2Local_start ( population *oldpop, void *data );
void operator_regrow2Local_end ( void *data );
void operator_regrow2Local ( population *oldpop, population *newpop, void *data );

/*** mutate2Local mwh added operator to do mutation with local information ***/
int operator_mutate2Local_init ( char *options, breedphase *bp );
void operator_mutate2Local_free ( void * );
void operator_mutate2Local_start ( population *oldpop, void *data );
void operator_mutate2Local_end ( void *data );
void operator_mutate2Local ( population *oldpop, population *newpop, void *data );
