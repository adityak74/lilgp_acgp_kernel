...
#define OPERATOR_REGROW2GLOBAL	6		/* added by mwh to regrow with lvl 1 info */
#define OPERATOR_MUTATION2GLOBAL	7		/* added by mwh to mutate with lvl 1 info */
#define OPERATOR_CROSSOVER2GLOBAL	8		/* added by mwh to crossover with lvl 1 info */
#define OPERATOR_REGROW2	9
#define OPERATOR_MUTATION2	10
#define OPERATOR_CROSSOVER2	11
#define OPERATOR_CROSSOVER2LOCAL	12
#define OPERATOR_REGROW2LOCAL	13
#define OPERATOR_MUTATION2LOCAL	14
