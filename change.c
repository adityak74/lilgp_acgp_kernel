...
{ { "crossover",      operator_crossover_init },
  ...
  /* mwh operators */
  /* operators to use level one root information mwh */
  { "regrow2Global", operator_regrow2Global_init},
  { "mutation2Global", operator_mutate2Global_init},
  { "crossover2Global",operator_crossover2Global_init}, 
  
  /* operators to use level one root and local informationi mwh */
  { "regrow2", operator_regrow2_init},
  { "mutation2", operator_mutate2_init},
  { "crossover2",operator_crossover2_init}, 

  /* operators to use lcl information but normal czj operators otherwise */
  { "crossover2Local",operator_crossover2Local_init},
  { "regrow2Local",operator_regrow2Local_init},
  { "mutation2Local",operator_mutate2Local_init},
 { NULL, NULL } };
